...
$(signupBtn).click(function () {
  ...
  confirmPassLabel.setAttribute("for", "passconfirm");
  let confirmPassInput = document.createElement("input");
  confirmPassInput.setAttribute("id", "passconfirm");

  //append
  signInForm.appendChild(confirmPassLabel);
  signInForm.appendChild(confirmPassInput);
  ...
  let stylee = window.getComputedStyle(signinBtn, '::before');
  stylee.color = 'blue';
});
